...
type TeamDetailScreenRouteProp = RouteProp<TeamsStackParamList, 'TeamDetail'>;
type TeamDetailScreenNavigationProp = StackNavigationProp<TeamsStackParamList, 'TeamDetail'>;
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.placeholder}>
          This screen will show team details, roster, and statistics.
        </Text>
      </View>
    </SafeAreaView>
  );
